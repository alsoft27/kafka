...
public class KafkaConfigConsumer {
	...
	@Bean
	public ConsumerFactory<String, SampleMessage> consumerFactory() {
		return new DefaultKafkaConsumerFactory<>(properties(), new StringDeserializer(),
				new JsonDeserializer<>(SampleMessage.class));
	}

	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, SampleMessage> kafkaListenerContainerFactory() {
